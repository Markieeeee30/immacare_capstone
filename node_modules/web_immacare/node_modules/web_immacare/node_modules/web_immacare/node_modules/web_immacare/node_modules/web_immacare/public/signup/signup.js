...
// //   input.addEventListener("input", () => {
// //     let value = input.value;
// //     if (isAllUppercase(value)) value = value.toLowerCase();
// //     input.value = capitalizeEachWord(value);
// //   });
// // });
...
// // // BLOCK SPECIAL CHARACTERS & NUMBERS IN NAME FIELDS
// // function blockSpecialCharacters(inputElement) {
// //   inputElement.value = inputElement.value.replace(/[^A-Za-z ]/g, "");
// // }
...
// //   const isMatch = value && confirmPasswordField.value === value;
// //   requirements.match.className = isMatch ? "valid" : "invalid";

// //   const allValid = Object.values(checks).every(Boolean) && isMatch;
